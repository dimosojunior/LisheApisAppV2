"""
URL configuration for LisheProject project.
...
urlpatterns = [
    ...
    path('',include('LisheApp.urls')),
    path('Apis/',include('LisheApis.urls')),
    path('Account/',include('AccountApis.urls')),
    path('Lishe/',include('LisheOptionsApis.urls')),
...
admin.site.site_header= "LISHE APP PROJECT"
